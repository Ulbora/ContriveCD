System.register(['@angular/core', '@angular/http', '../../business/credentials/credentials', 'rxjs/Observable', 'rxjs/add/operator/do', 'rxjs/add/operator/map', 'rxjs/add/operator/catch'], function(exports_1) {
    ...
    return {
        setters:[
            ...
            function (_3) {}],
        execute: function() {
            DeleteLocationService = (function () {
                function DeleteLocationService(http) {
                    this.http = http;
                    this.locationUrl = './rs/location';
                }
                DeleteLocationService.prototype.getLocation = function (id) {
                ...
                DeleteLocationService.prototype.deleteLocation = function (id) {
                    var deleteUrl = this.locationUrl + ("/" + id);
                    var creds = new credentials_1.Credentials();
                    var headers = new http_2.Headers();
                    headers.append('Authorization', 'Basic ' + creds.getToken());
                    var options = new http_2.RequestOptions({ headers: headers });
                ...
                DeleteLocationService.prototype.handleError = function (error) {
                    console.error(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                DeleteLocationService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], DeleteLocationService);
                return DeleteLocationService;
            })();
            exports_1("DeleteLocationService", DeleteLocationService);
        }
    }
});
//# sourceMappingURL=delete-location.service.js.map