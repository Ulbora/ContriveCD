        ...
        execute: function() {
            LocationListService = (function () {
                function LocationListService(http) {
                    this.http = http;
                    this.locationUrl = './rs/location/list';
                }
                LocationListService.prototype.getLocationList = function () {
                ...
                LocationListService.prototype.handleError = function (error) {
                    console.error(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                LocationListService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], LocationListService);
                return LocationListService;
            })();
            exports_1("LocationListService", LocationListService);
        }
    }
});
//# sourceMappingURL=location-list.service.js.map